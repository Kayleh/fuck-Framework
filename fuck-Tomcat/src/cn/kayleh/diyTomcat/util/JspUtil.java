...
//jsp.class它继承了 HttpJspBase 这个类
//而 HttpJspBase 又继承了 JspPage 类
//最后 JspPage 又继承了 HttpServlet 类。
//所以 index_jsp 这个类，本质上就是一个 Servlet。
...
public class JspUtil {
    ...
    public static void main(String[] args) {
        try {
            Context context = new Context("/javaweb", "d:/project/javaee/web", null, true);
            File file = new File("d:/project/javaee/web/index.jsp");

...
public class ThreadPoolUtil {
     ...
     * 是把这些请求放过在 这个 LinkedBlockingQueue里， 当核心线程忙过来了，就会来处理 这个队列里的请求。 只有当处理不过来的请求数目超过 了 10个之后，才会增加更多的线程来处理。
     */
    private static ThreadPoolExecutor threadPool =
            new ThreadPoolExecutor(20, 20, 60, TimeUnit.SECONDS, new LinkedBlockingQueue<Runnable>(10));
